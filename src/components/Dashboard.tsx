	...
	return (
		<div className="space-y-6 animate-fade-in">
			<Tabs defaultValue="fafsa" className="w-full">
				...
				<TabsContent value="fafsa" className="animate-fade-in space-y-4 transition-opacity duration-500">
					<Card>
						<CardHeader>
							<CardTitle>FAFSA Resources</CardTitle>
							<CardDescription>
								Get started with the Free Application for Federal Student Aid. Submitting early improves
								your chances of receiving grants and institutional aid.
							</CardDescription>
						</CardHeader>
						<CardContent>
				...
				<TabsContent value="scholarships" className="animate-fade-in space-y-4 transition-opacity duration-500">
					<Card>
						<CardHeader>
							<CardTitle>Scholarship Resources</CardTitle>
							<CardDescription>
								Explore scholarships that match your academic, extracurricular, and personal profile.
								Apply early and often to maximize aid.
							</CardDescription>
						</CardHeader>
						<CardContent>
							<ul className="list-disc list-inside space-y-2 text-muted-foreground text-sm">
